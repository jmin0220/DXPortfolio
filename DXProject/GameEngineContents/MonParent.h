...
// 설명 :
class MonParent : public Monster
{
public:
	...
	// delete Function
	MonParent(const MonParent& _Other) = delete;
	MonParent(MonParent&& _Other) noexcept = delete;
	MonParent& operator=(const MonParent& _Other) = delete;
	MonParent& operator=(MonParent&& _Other) noexcept = delete;
